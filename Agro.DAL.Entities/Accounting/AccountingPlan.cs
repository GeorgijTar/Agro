...
public class AccountingPlan : Entity
{
    ...
    public  AccountingPlan? ParentPlan { get => _parentPlan; set => Set(ref _parentPlan, value); }
    ...
    public  ICollection<AccountingPlan>? ChildPlans { get => _childPlans; set => Set(ref _childPlans, value); }
